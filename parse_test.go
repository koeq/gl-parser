...
func TestTokenization(t *testing.T) {
	input := "Benchpress @90kg 5*5 \n Benchpress @87,5lbs 5/5"
	expectedTokens := []Token{{String, "Benchpress", "Benchpress", 1}, {WhiteSpace, " ", nil, 1}, {Asperand, "@", nil, 1}, {Number, "90", 90.0, 1}, {WeightUnit, "kg", "kg", 1}, {WhiteSpace, " ", nil, 1}, {Number, "5", 5.0, 1}, {Asterisk, "*", nil, 1}, {Number, "5", 5.0, 1}, {WhiteSpace, " ", nil, 1}, {Newline, "\n", nil, 1}, {WhiteSpace, " ", nil, 2}, {String, "Benchpress", "Benchpress", 2}, {WhiteSpace, " ", nil, 2}, {Asperand, "@", nil, 2}, {Number, "87.5", 87.5, 2}, {WeightUnit, "lbs", "lbs", 2}, {WhiteSpace, " ", nil, 2}, {Number, "5", 5.0, 2}, {ForwardSlash, "/", nil, 2}, {Number, "5", 5.0, 2}, {EOF, "", nil, 2}}
